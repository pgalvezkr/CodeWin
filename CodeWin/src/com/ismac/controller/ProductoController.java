...
public class ProductoController {
	...
	public static void crearProducto(Producto producto) {
		try {
			...
			System.out.println("Ocurri� un error al guardar las producto " + e.getMessage());
			e.printStackTrace();
		}
	}
	...
	public static List<Producto> getProducto() {
		...
		try {
			...
			System.out.println("Ocurri� un error al consultar las productos " + e.getMessage());
			e.printStackTrace();
		}
		return productos;
	}
	...
	public static void actualizarProducto(int id, Producto producto) {
		try {
			...
			System.out.println("Ocurri� un error al actualizar el producto " + e.getMessage());
			e.printStackTrace();
		}
	...
	public static void eliminarProducto(int id) {
		try {
			...
			System.out.println("Ocurri� un error al eliminar el producto " + e.getMessage());
			e.printStackTrace();
		}
	}
